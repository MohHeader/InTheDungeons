...
namespace FloorPlanner
{
    public class FloorPlanBuilder : DungeonBuilder
    {
        ...
        readonly static string MARKER_GROUND = "Ground";
        readonly static string MARKER_CEILING = "Ceiling";
        readonly static string MARKER_WALL = "Wall";
        readonly static string MARKER_DOOR = "Door";
        readonly static string MARKER_BUILDING_WALL = "BuildingWall";
        ...
        string GetDoorMarkerName(FloorChunk ChunkA, FloorChunk ChunkB)
        {
            ...
            return PreferedChunk.DoorMarker.Length > 0 ? PreferedChunk.DoorMarker : MARKER_DOOR;
        }
	        ...
	        for (int y = 0; y < NumFloors; y++) {
		        for (int x = -1; x < floorPlanConfig.BuildingSize.x; x++) {
			        ...
			        for (int z = -1; z < floorPlanConfig.BuildingSize.z; z++) {
				        ...
				        string GroundMarkerName = MARKER_GROUND;
				        string CeilingMarkerName = MARKER_CEILING;
				        ...
				        string DoorMarkerName = MARKER_DOOR;
				        if (Chunk00 != null && Chunk00.DoorMarker.Length > 0) {
